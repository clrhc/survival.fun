...
`);
  ...
  const determineFate = async (scenario: string, agentName: string) => {
    setIsThinking(true);
...
Use the scenario: ${scenario} and the user’s Final Action: ${messages.text} to deliver your judgment.`);
